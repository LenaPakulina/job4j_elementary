...
public class MathCalculator {
    ...
    public static double diffAndDiv(double first, double second) {
        return (diff(first, second) + customDivision(first, second));
    }

    public static double getRslAllOperations(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета 3 равен: " + getRslAllOperations(10, 20));
    }
}
